...
// Wrap application routes with Prometheus middleware to ensure metrics are recorded
Route::middleware([\App\Http\Middleware\PrometheusMiddleware::class])->group(function () {
